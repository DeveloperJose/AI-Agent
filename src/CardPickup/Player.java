...
public abstract class Player {
    protected String playerName = "defaultPlayer"; // Overwrite this variable in
    ...
    protected int oppNode;
    /** Opponent's current position */
    protected Card oppLastCard;

    /** Opponent's last picked up card */
     ...
     * Trust it to call this function to update your location if your movie is
     * legal.
    ...
    /**
     * Sets your current Hand. This does not change your actual hand, just your
     * copy of it.
    ...
    /**
     * GameMaster will use this method to determine if a player has finished
     * their moves
     * @return size of hand
     */
    ...
    /**
     * This method forces the subclass player to make a single action (pickup or
     * move a card).
        ...
        if (a != null) {
            switch (a.move) {
                ...
                case PICKUP:
                    ...
                    break;
                default:
                    lastAction = null; // indicates that the player has made an
                                       // erroneous move
                    break;
            }
        }
    ...
    /**
     * Method that is used to determine if a move is valid. This method should
     * be used to help players
     * determine if their actions are valid. GameMaster has a local copy of this
     * method and all the
     * required variables (such as the true graph), so manipulating the
     * variables to turn a previously
     * invalid action in to a "valid" one will not help you as the GameMaster
     * will still see the action
     * as invalid.
     * 
